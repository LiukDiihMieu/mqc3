...
This client runs circuit representations on the local PyTorch backend. The
remote (cloud) execution path has been removed in MQC-mini.
"""
...
class SimulatorClient(AbstractClient):
    ...
    Representations are simulated locally with PyTorch.
